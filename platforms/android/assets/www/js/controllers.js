...
.controller('NewGigCtrl', function($scope, $location, $ionicPopup, GigAPI, cordovaGeolocationService) {
    ...
    //}
       ...
       $scope.shareGame = function() {
        var message = {
            subject: $scope.currentNewGame.sport,
            text:  "Sport: " + $scope.currentNewGame.sport + " \n" + $scope.currentNewGame.description + " \n" + "Time: " + $scope.currentNewGame.date + " \n" + "Location: " + $scope.currentNewGame.location + " \n" ,
